...
public class UsernameManager : MonoBehaviour
{
    ...
    [SerializeField] private GameObject badWordPopup;
    ...
    public void OnSubmitButtonClicked()
    {
        ...
        // Convert playerName to lowercase
        playerName = playerName.ToLower();

        // Check if playerName is not empty and within length limit
        if (!string.IsNullOrEmpty(playerName) && playerName.Length <= 10)
        {
            // Check if playerName is a bad word
            if (System.Array.IndexOf(badWords, playerName) == -1)
            {
        ...
        {
            // Show error popup for empty or too long name
